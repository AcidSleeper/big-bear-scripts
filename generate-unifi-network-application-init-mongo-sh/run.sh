...
if ! curl -L "https://raw.githubusercontent.com/bigbeartechworld/big-bear-video-assets/refs/heads/main/portainer/unifi-network-application/init-mongo.sh" -o "$location"; then
